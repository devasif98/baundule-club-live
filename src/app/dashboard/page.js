    ...
    <>
      <div className="dash-header">
        <div className="container mx-auto">
          ...
          >
            <h3 className="mb-2 text-white uppercase display-4">Dashboard</h3>
          </div>
        </div>
      </div>
      <Status />
...
const Status = () => {
  return (
    <>
      <div className="p-5 m-2 overflow-hidden transition rounded-lg shadow hover:shadow-lg md:m-5">
        <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
          <div className="flex p-4 space-x-4 text-gray-100 bg-gray-900 rounded-lg md:space-x-6">
          ...
          <div className="flex p-4 space-x-4 text-gray-100 bg-gray-900 rounded-lg md:space-x-6">
            ...
            <div className="flex flex-col justify-center align-middle">
              ...
              <p className="capitalize">Success Tour</p>
            </div>
          </div>
          <div className="flex p-4 space-x-4 text-gray-100 bg-gray-900 rounded-lg md:space-x-6">
            <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-lime-400">
            ...
            <div className="flex flex-col justify-center align-middle">
              <div className="flex">
                <p className="text-3xl font-semibold leading">4.8</p> <FaStar />
              </div>
